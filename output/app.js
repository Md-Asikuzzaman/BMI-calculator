"use strict";
var bmi__age = document.querySelector('#bmi__age');
var bmi__weight = document.querySelector('#bmi__weight');
var bmi__feet = document.querySelector('#bmi__feet');
var bmi__inch = document.querySelector('#bmi__inch');
var bmi__output = document.querySelector('#bmi__output');
var bmi__btn = document.querySelector('.bmi__btn');
var pointer = document.querySelector('.hand-pointer');
const resetValue = () => {
    bmi__age.value = '';
    bmi__weight.value = '';
